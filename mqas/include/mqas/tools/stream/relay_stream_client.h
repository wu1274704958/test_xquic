...
class MQAS_EXTERN RelayStreamClient : public core::ProtoBufStream<RelayStreamClient,
relay::ReqRelayPair,relay::RespondRelayPair,
relay::ReqReadyPair,relay::RespondReadyPair> 
{
public://udp same
RelayStreamClient(){}
...
void recv_start();
void on_read_msg_s(const std::shared_ptr<proto::relay::RespondReady>& m);
public:
